...
// Inngestfunctrion to save workspace data to a database
                ...
                if(task.status !== "DONE"){
                    await step.run('send-task-reminder-mail', async () => {
                        await sendEmail({
                            ...
                            color: #007bff; margin: 8px 0;">${task.title}</p>[     
                            ...
                            #007bff; padding: 12px 24px 24px; border-radius:
